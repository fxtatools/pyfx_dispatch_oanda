...
class ListPositions200Response(BaseModel):
    """
    ListPositions200Response
    """
    positions: Optional[conlist(Position)] = Field(None, description="The list of Account Positions.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ListPositions200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPositions200Response:
        """Create an instance of ListPositions200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListPositions200Response.parse_obj(obj)

        _obj = ListPositions200Response.parse_obj({
