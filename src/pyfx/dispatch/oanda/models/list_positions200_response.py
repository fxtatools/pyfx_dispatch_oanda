"""ListPositions200Response model definition for OANDA v20 REST API (3.0.25)"""
...
class ListPositions200Response(LastTransactionResponse):
    """
...
__all__ = ("ListPositions200Response",)
