...
class TransactionHeartbeat(BaseModel):
    """
    ...
    __properties = ["type", "lastTransactionID", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "TransactionHeartbeat":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionHeartbeat:
        """Create an instance of TransactionHeartbeat from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionHeartbeat.parse_obj(obj)

        _obj = TransactionHeartbeat.parse_obj({
            "type": obj.get("type"),
