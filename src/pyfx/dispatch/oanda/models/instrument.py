...
class Instrument(ApiObject):
    ...
    type: Annotated[InstrumentType, TransportField(...)]
    """
    The type of the Instrument
    """

    display_name: Annotated[str, TransportField(..., alias="displayName")]
    """
    The display name of the Instrument
    """

    pip_location: Annotated[int, TransportField(..., alias="pipLocation")]
    """
    ...
    display_precision: Annotated[int, TransportField(..., alias="displayPrecision")]
    """
    ...
    trade_units_precision: Annotated[Optional[int], TransportField(None, alias="tradeUnitsPrecision")]
    """
    The amount of decimal places that may be provided when specifying the number of units traded for this instrument.
    """

    minimum_trade_size: Annotated[Optional[LotsValue], TransportField(None, alias="minimumTradeSize")]
    """
    The smallest number of units allowed to be traded for this instrument.
    """

    maximum_trailing_stop_distance: Annotated[Optional[PriceValue], TransportField(None, alias="maximumTrailingStopDistance")]
    """
    The maximum trailing stop distance allowed for a trailing stop loss created for this instrument. Specified in price units.
    """

    minimum_trailing_stop_distance: Annotated[Optional[PriceValue], TransportField(None, alias="minimumTrailingStopDistance")]
    """
    The minimum trailing stop distance allowed for a trailing stop loss created for this instrument. Specified in price units.
    """

    maximum_position_size: Annotated[Optional[LotsValue], TransportField(None, alias="maximumPositionSize")]
    """
    The maximum position size allowed for this instrument. Specified in units.
    """

    maximum_order_units: Annotated[Optional[LotsValue], TransportField(None, alias="maximumOrderUnits")]
    """
    ...
    commission: Annotated[Optional[InstrumentCommission], TransportField(None)]
    """
    ...
    guaranteed_stop_loss_order_mode: Annotated[Optional[GuaranteedStopLossOrderMode], TransportField(None, alias="guaranteedStopLossOrderMode")]
    """
    ...
    tags: Annotated[Optional[list[Tag]], TransportField(None)]
    """
