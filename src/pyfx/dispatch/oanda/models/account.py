...
class Account(BaseModel):
    ...
    trades: Optional[conlist(TradeSummary)] = Field(None, description="The details of the Trades currently open in the Account.")
    positions: Optional[conlist(Position)] = Field(None, description="The details all Account Positions.")
    orders: Optional[conlist(Order)] = Field(None, description="The details of the Orders currently pending in the Account.")
    ...
    def from_dict(cls, obj: dict) -> Account:
        ...
        _obj = Account.parse_obj({
            ...
            "trades": [TradeSummary.from_dict(_item) for _item in obj.get("trades")] if obj.get("trades") is not None else None,
