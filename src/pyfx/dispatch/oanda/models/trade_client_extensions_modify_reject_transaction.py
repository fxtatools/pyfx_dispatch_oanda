...
class TradeClientExtensionsModifyRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"TRADE_CLIENT_EXTENSIONS_MODIFY_REJECT\" for a TradeClientExtensionsModifyRejectTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "tradeID", "clientTradeID", "tradeClientExtensionsModify", "rejectReason"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TradeClientExtensionsModifyRejectTransaction:
        """Create an instance of TradeClientExtensionsModifyRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TradeClientExtensionsModifyRejectTransaction.parse_obj(obj)

        _obj = TradeClientExtensionsModifyRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
