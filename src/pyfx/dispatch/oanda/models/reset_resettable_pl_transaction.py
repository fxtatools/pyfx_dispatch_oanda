...
class ResetResettablePLTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"RESET_RESETTABLE_PL\" for a ResetResettablePLTransaction.")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResetResettablePLTransaction:
        """Create an instance of ResetResettablePLTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResetResettablePLTransaction.parse_obj(obj)

        _obj = ResetResettablePLTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
