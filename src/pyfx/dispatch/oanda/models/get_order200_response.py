...
class GetOrder200Response(BaseModel):
    ...
    __properties = ["order", "lastTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "GetOrder200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOrder200Response:
        """Create an instance of GetOrder200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOrder200Response.parse_obj(obj)

        _obj = GetOrder200Response.parse_obj({
