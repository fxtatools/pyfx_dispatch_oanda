...
class TransferFundsTransaction(Transaction):
    ...
    type: Literal[TransactionType.TRANSFER_FUNDS] = TransportField(TransactionType.TRANSFER_FUNDS)
    """
    The Type of the Transaction. Always set to \"TRANSFER_FUNDS\" in a TransferFundsTransaction.
    """

    amount: Optional[AccountUnits] = TransportField(None)
    """
    ...
    funding_reason: Optional[FundingReason] = TransportField(None, alias="fundingReason")
    """
