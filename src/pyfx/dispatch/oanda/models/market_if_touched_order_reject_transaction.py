...
class MarketIfTouchedOrderRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"MARKET_IF_TOUCHED_ORDER_REJECT\" in a MarketIfTouchedOrderRejectTransaction.")
    ...
    reason: Optional[StrictStr] = Field(None, description="The reason that the Market-if-touched Order was initiated")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "instrument", "units", "price", "priceBound", "timeInForce", "gtdTime", "positionFill", "triggerCondition", "reason", "clientExtensions", "takeProfitOnFill", "stopLossOnFill", "trailingStopLossOnFill", "tradeClientExtensions", "intendedReplacesOrderID", "rejectReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "MarketIfTouchedOrderRejectTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarketIfTouchedOrderRejectTransaction:
        """Create an instance of MarketIfTouchedOrderRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarketIfTouchedOrderRejectTransaction.parse_obj(obj)

        _obj = MarketIfTouchedOrderRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
