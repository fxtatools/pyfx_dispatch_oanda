...
class MarketIfTouchedOrderTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"MARKET_IF_TOUCHED_ORDER\" in a MarketIfTouchedOrderTransaction.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "MarketIfTouchedOrderTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarketIfTouchedOrderTransaction:
        """Create an instance of MarketIfTouchedOrderTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarketIfTouchedOrderTransaction.parse_obj(obj)

        _obj = MarketIfTouchedOrderTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
