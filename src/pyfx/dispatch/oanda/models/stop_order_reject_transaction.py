...
class StopOrderRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"STOP_ORDER_REJECT\" in a StopOrderRejectTransaction.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "StopOrderRejectTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StopOrderRejectTransaction:
        """Create an instance of StopOrderRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StopOrderRejectTransaction.parse_obj(obj)

        _obj = StopOrderRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
