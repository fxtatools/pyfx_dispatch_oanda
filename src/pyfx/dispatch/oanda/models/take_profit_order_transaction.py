...
class TakeProfitOrderTransaction(OrderStopsTransaction):
    ...
    type: Annotated[Literal[TransactionType.TAKE_PROFIT_ORDER], TransportField(TransactionType.TAKE_PROFIT_ORDER)] = TransactionType.TAKE_PROFIT_ORDER
    """
    ...
    reason: Annotated[TakeProfitOrderReason, TransportField(...)]
    """
