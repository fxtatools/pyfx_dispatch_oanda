...
class TakeProfitOrder(BaseModel):
    ...
    type: Optional[StrictStr] = Field(None, description="The type of the Order. Always set to \"TAKE_PROFIT\" for Take Profit Orders.")
    ...
    __properties = ["id", "createTime", "state", "clientExtensions", "type", "tradeID", "clientTradeID", "price", "timeInForce", "gtdTime", "triggerCondition", "fillingTransactionID", "filledTime", "tradeOpenedID", "tradeReducedID", "tradeClosedIDs", "cancellingTransactionID", "cancelledTime", "replacesOrderID", "replacedByOrderID"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TakeProfitOrder:
        """Create an instance of TakeProfitOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TakeProfitOrder.parse_obj(obj)

        _obj = TakeProfitOrder.parse_obj({
            "id": obj.get("id"),
