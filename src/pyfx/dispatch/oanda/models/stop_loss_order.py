...
class StopLossOrder(LimitOrderMixin, TradeIdMixin, ReplacesOrderMixin):
    ...
    type: Literal[OrderType.STOP_LOSS] = TransportField(OrderType.STOP_LOSS)
    """
    ...
    guaranteed: Optional[bool] = TransportField(None, deprecated=True)
    """
    ...
    guaranteed_execution_premium: Optional[PriceValue] = TransportField(None, deprecated=True, alias="guaranteedExecutionPremium")
    """
