...
class OrderCancelTransaction(Transaction):
    ...
    type: Literal[TransactionType.ORDER_CANCEL] = TransportField(TransactionType.ORDER_CANCEL)
    """
    ...
    client_order_id: Optional[OrderId] = TransportField(None, alias="clientOrderID")
    """
    The client ID of the Order cancelled (only provided if the Order has a client Order ID).
    """

    reason: Optional[OrderCancelReason] = TransportField(None)
    """
    ...
    closed_trade_id: Optional[TradeId] = TransportField(None, alias="closedTradeID")
    """
    This field is supplemental to the fxTrade v20 API 3.0.25.
    Value type has been inferred from server response.
    """

    trace_close_transaction_id: Optional[TransactionId] = TransportField(None, alias="tradeCloseTransactionID")
    """
    This field is supplemental to the fxTrade v20 API 3.0.25
    Value type has been inferred from server response.
    """
