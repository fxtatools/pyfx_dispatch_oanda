...
class AccountProperties(BaseModel):
    ...
    mt4_account_id: Optional[StrictInt] = Field(None, alias="mt4AccountID", description="The Account's associated MT4 Account ID. This field will not be present if the Account is not an MT4 account.")
    tags: Optional[conlist(StrictStr)] = Field(None, description="The Account's tags")
    additional_properties: Dict[str, Any] = {}
    __properties = ["id", "mt4AccountID", "tags"]
    ...
    def from_dict(cls, obj: dict) -> AccountProperties:
        ...
        _obj = AccountProperties.parse_obj({
            "id": obj.get("id"),
            "mt4_account_id": obj.get("mt4AccountID"),
            "tags": obj.get("tags")
        })
