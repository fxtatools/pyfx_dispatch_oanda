...
class DelayedTradeClosureTransaction(Transaction):
    ...
    type: Annotated[Literal[TransactionType.DELAYED_TRADE_CLOSURE], TransportField(TransactionType.DELAYED_TRADE_CLOSURE)] = TransactionType.DELAYED_TRADE_CLOSURE
    """
    ...
    trade_ids: Annotated[Optional[TradeId], TransportField(None, alias="tradeIDs")]
