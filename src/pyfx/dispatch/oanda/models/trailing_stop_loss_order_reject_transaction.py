...
class TrailingStopLossOrderRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"TRAILING_STOP_LOSS_ORDER_REJECT\" in a TrailingStopLossOrderRejectTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "tradeID", "clientTradeID", "distance", "timeInForce", "gtdTime", "triggerCondition", "reason", "clientExtensions", "orderFillTransactionID", "intendedReplacesOrderID", "rejectReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "TrailingStopLossOrderRejectTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingStopLossOrderRejectTransaction:
        """Create an instance of TrailingStopLossOrderRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrailingStopLossOrderRejectTransaction.parse_obj(obj)

        _obj = TrailingStopLossOrderRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
