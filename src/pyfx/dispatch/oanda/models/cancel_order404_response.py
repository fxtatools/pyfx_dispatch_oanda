...
class CancelOrder404Response(BaseModel):
    """
    CancelOrder404Response
    """
    order_cancel_reject_transaction: Optional[OrderCancelRejectTransaction] = Field(None, alias="orderCancelRejectTransaction")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "CancelOrder404Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelOrder404Response:
        """Create an instance of CancelOrder404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelOrder404Response.parse_obj(obj)

        _obj = CancelOrder404Response.parse_obj({
            "order_cancel_reject_transaction": OrderCancelRejectTransaction.from_dict(obj.get("orderCancelRejectTransaction")) if obj.get("orderCancelRejectTransaction") is not None else None,
