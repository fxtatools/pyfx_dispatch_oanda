"""StreamTransactions200Response model definition for OANDA v20 REST API (3.0.25)"""
...
class StreamTransactions200Response(ApiObject):
    ...
    Each chunk contains Transaction and/or TransactionHeartbeat objects encoded as JSON.  
...
__all__ = ("StreamTransactions200Response",)
