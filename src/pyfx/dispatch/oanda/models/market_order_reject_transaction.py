...
class MarketOrderRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"MARKET_ORDER_REJECT\" in a MarketOrderRejectTransaction.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "MarketOrderRejectTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarketOrderRejectTransaction:
        """Create an instance of MarketOrderRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarketOrderRejectTransaction.parse_obj(obj)

        _obj = MarketOrderRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
