...
class MarginCallExtendTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"MARGIN_CALL_EXTEND\" for an MarginCallExtendTransaction.")
    extension_number: Optional[StrictInt] = Field(None, alias="extensionNumber", description="The number of the extensions to the Account's current margin call that have been applied. This value will be set to 1 for the first MarginCallExtend Transaction")
    additional_properties: Dict[str, Any] = {}
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "extensionNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "MarginCallExtendTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarginCallExtendTransaction:
        """Create an instance of MarginCallExtendTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarginCallExtendTransaction.parse_obj(obj)

        _obj = MarginCallExtendTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
            ...
            "type": obj.get("type"),
            "extension_number": obj.get("extensionNumber")
        })
