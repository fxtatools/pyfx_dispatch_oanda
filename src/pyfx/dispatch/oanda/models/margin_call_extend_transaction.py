...
class MarginCallExtendTransaction(Transaction):
    ...
    type: Literal[TransactionType.MARGIN_CALL_EXTEND] = TransportField(TransactionType.MARGIN_CALL_EXTEND)
    """
    The Type of the Transaction. Always set to \"MARGIN_CALL_EXTEND\" for an MarginCallExtendTransaction.
    """

    extension_number: Optional[int] = TransportField(None, alias="extensionNumber")
    """
