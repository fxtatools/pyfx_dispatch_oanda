...
class SetTradeClientExtensions400Response(BaseModel):
    """
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetTradeClientExtensions400Response:
        """Create an instance of SetTradeClientExtensions400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetTradeClientExtensions400Response.parse_obj(obj)

        _obj = SetTradeClientExtensions400Response.parse_obj({
