...
class SetTradeClientExtensions400Response(ApiObject):
    """
    SetTradeClientExtensions400Response
    """
    trade_client_extensions_modify_reject_transaction: Optional[TradeClientExtensionsModifyRejectTransaction] = TransportField(None, alias="tradeClientExtensionsModifyRejectTransaction")
