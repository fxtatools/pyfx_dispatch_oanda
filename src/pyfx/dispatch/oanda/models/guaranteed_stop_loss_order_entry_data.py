...
class GuaranteedStopLossOrderEntryData(ApiObject):
    ...
    """
    minimum_distance: Optional[PriceValue] = TransportField(None, alias="minimumDistance")
    """
    ...
    """
    premium: Optional[str] = TransportField(None)
    """
    ...
    """
    level_restriction: Optional[GuaranteedStopLossOrderLevelRestriction] = TransportField(None, alias="levelRestriction")
