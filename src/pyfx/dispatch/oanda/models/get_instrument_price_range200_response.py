...
class GetInstrumentPriceRange200Response(BaseModel):
    """
    GetInstrumentPriceRange200Response
    """
    prices: Optional[conlist(Price)] = Field(None, description="The list of prices that satisfy the request.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "GetInstrumentPriceRange200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInstrumentPriceRange200Response:
        """Create an instance of GetInstrumentPriceRange200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInstrumentPriceRange200Response.parse_obj(obj)

        _obj = GetInstrumentPriceRange200Response.parse_obj({
