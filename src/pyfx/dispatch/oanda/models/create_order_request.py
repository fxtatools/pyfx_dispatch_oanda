...
class CreateOrderRequest(BaseModel):
    ...
    CreateOrderRequest
    """
    order: Optional[Dict[str, Any]] = Field(None, description="The base Order specification used when requesting that an Order be created. Each specific Order-type extends this definition.")
