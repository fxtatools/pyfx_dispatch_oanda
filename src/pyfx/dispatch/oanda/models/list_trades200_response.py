...
class ListTrades200Response(BaseModel):
    """
    ListTrades200Response
    """
    trades: Optional[conlist(Trade)] = Field(None, description="The list of Trade detail objects")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ListTrades200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTrades200Response:
        """Create an instance of ListTrades200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTrades200Response.parse_obj(obj)

        _obj = ListTrades200Response.parse_obj({
