...
class MarginCallExitTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"MARGIN_CALL_EXIT\" for an MarginCallExitTransaction.")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarginCallExitTransaction:
        """Create an instance of MarginCallExitTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarginCallExitTransaction.parse_obj(obj)

        _obj = MarginCallExitTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
