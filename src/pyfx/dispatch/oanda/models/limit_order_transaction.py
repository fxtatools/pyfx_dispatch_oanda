...
class LimitOrderTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"LIMIT_ORDER\" in a LimitOrderTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "instrument", "units", "price", "timeInForce", "gtdTime", "positionFill", "triggerCondition", "reason", "clientExtensions", "takeProfitOnFill", "stopLossOnFill", "trailingStopLossOnFill", "tradeClientExtensions", "replacesOrderID", "cancellingTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "LimitOrderTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LimitOrderTransaction:
        """Create an instance of LimitOrderTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LimitOrderTransaction.parse_obj(obj)

        _obj = LimitOrderTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
