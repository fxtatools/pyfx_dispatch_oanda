...
class ReplaceOrder400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ReplaceOrder400Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReplaceOrder400Response:
        """Create an instance of ReplaceOrder400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplaceOrder400Response.parse_obj(obj)

        _obj = ReplaceOrder400Response.parse_obj({
