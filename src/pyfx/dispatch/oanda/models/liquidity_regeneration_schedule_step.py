...
class LiquidityRegenerationScheduleStep(ApiObject):
    ...
    """
    bid_liquidity_used: Annotated[Optional[str], TransportField(None, alias="bidLiquidityUsed")]
    """
    The amount of bid liquidity used at this step in the schedule.
    """
    ask_liquidity_used: Annotated[Optional[str], TransportField(None, alias="askLiquidityUsed")]
    """
