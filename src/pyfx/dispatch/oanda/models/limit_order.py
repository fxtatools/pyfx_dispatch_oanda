...
class LimitOrder(BaseModel):
    ...
    type: Optional[StrictStr] = Field(None, description="The type of the Order. Always set to \"LIMIT\" for Limit Orders.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "LimitOrder":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LimitOrder:
        """Create an instance of LimitOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LimitOrder.parse_obj(obj)

        _obj = LimitOrder.parse_obj({
            "id": obj.get("id"),
