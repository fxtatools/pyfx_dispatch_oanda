...
class TrailingStopLossOrderTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"TRAILING_STOP_LOSS_ORDER\" in a TrailingStopLossOrderTransaction.")
    ...
    distance: Optional[StrictStr] = Field(None, description="The price distance (in price units) specified for the TrailingStopLoss Order.")
    time_in_force: Optional[StrictStr] = Field(None, alias="timeInForce", description="The time-in-force requested for the TrailingStopLoss Order. Restricted to \"GTC\", \"GFD\" and \"GTD\" for TrailingStopLoss Orders.")
    ...
    reason: Optional[StrictStr] = Field(None, description="The reason that the Trailing Stop Loss Order was initiated")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "tradeID", "clientTradeID", "distance", "timeInForce", "gtdTime", "triggerCondition", "reason", "clientExtensions", "orderFillTransactionID", "replacesOrderID", "cancellingTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "TrailingStopLossOrderTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingStopLossOrderTransaction:
        """Create an instance of TrailingStopLossOrderTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrailingStopLossOrderTransaction.parse_obj(obj)

        _obj = TrailingStopLossOrderTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
