"""PositionBook model definition for OANDA v20 REST API (3.0.25)"""
...
class PositionBook(ApiObject):
    ...
    instrument: Annotated[InstrumentName, TransportField(None)]
    ...
    buckets: Annotated[Optional[list[PositionBookBucket]], TransportField(None)]
