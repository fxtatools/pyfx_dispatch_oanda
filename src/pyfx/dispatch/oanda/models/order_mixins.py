...
class OrderBase(Order):
    ...
    filling_transaction_id: Annotated[Optional[TransactionId], TransportField(None, alias="fillingTransactionID")]
    """
    ...
    trade_opened_id: Annotated[Optional[TradeId], TransportField(None, alias="tradeOpenedID")]
    """
    ...
    trade_reduced_id: Annotated[Optional[TradeId], TransportField(None, alias="tradeReducedID")]
    """
    ...
    trade_closed_ids: Annotated[Optional[list[TradeId]], TransportField(None, alias="tradeClosedIDs")]
    """
...
class LimitOrderMixin(OrderBase):
    ...
    trigger_condition: Annotated[Optional[OrderTriggerCondition], TransportField(OrderTriggerCondition.DEFAULT, alias="triggerCondition")]
    """
...
class UnitsOrderBase(OrderBase):
    ...
    position_fill: Annotated[Optional[OrderPositionFill], TransportField(OrderPositionFill.DEFAULT, alias="positionFill")]
    """
