...
class LimitOrderRequest(BaseModel):
    ...
    """
    type: Optional[StrictStr] = Field(None, description="The type of the Order to Create. Must be set to \"LIMIT\" when creating a Market Order.")
    ...
    __properties = ["type", "instrument", "units", "price", "timeInForce", "gtdTime", "positionFill", "triggerCondition", "clientExtensions", "takeProfitOnFill", "stopLossOnFill", "trailingStopLossOnFill", "tradeClientExtensions"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LimitOrderRequest:
        """Create an instance of LimitOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LimitOrderRequest.parse_obj(obj)

        _obj = LimitOrderRequest.parse_obj({
            "type": obj.get("type"),
