...
class DynamicOrderState(ApiObject):
    ...
    """The Order's ID.
    """
    trailing_stop_value: Optional[str] = TransportField(None, alias="trailingStopValue")
    """The Order's calculated trailing stop value.
    """
    trigger_distance: Optional[PriceValue] = TransportField(None, alias="triggerDistance")
    ...
    """
    is_trigger_distance_exact: Optional[bool] = TransportField(None, alias="isTriggerDistanceExact")
