...
class SetOrderClientExtensions404Response(ApiObject):
    """
    SetOrderClientExtensions404Response
    """
    order_client_extensions_modify_reject_transaction: Optional[OrderClientExtensionsModifyRejectTransaction] = TransportField(None, alias="orderClientExtensionsModifyRejectTransaction")
