...
class SetOrderClientExtensions404Response(BaseModel):
    """
    SetOrderClientExtensions404Response
    """
    order_client_extensions_modify_reject_transaction: Optional[OrderClientExtensionsModifyRejectTransaction] = Field(None, alias="orderClientExtensionsModifyRejectTransaction")
    ...
    __properties = ["orderClientExtensionsModifyRejectTransaction", "lastTransactionID", "relatedTransactionIDs", "errorCode", "errorMessage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "SetOrderClientExtensions404Response":
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of order_client_extensions_modify_reject_transaction
        if self.order_client_extensions_modify_reject_transaction:
            _dict['orderClientExtensionsModifyRejectTransaction'] = self.order_client_extensions_modify_reject_transaction.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetOrderClientExtensions404Response:
        """Create an instance of SetOrderClientExtensions404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetOrderClientExtensions404Response.parse_obj(obj)

        _obj = SetOrderClientExtensions404Response.parse_obj({
            "order_client_extensions_modify_reject_transaction": OrderClientExtensionsModifyRejectTransaction.from_dict(obj.get("orderClientExtensionsModifyRejectTransaction")) if obj.get("orderClientExtensionsModifyRejectTransaction") is not None else None,
