...
class TradeSummary(ApiObject):
    ...
    open_time: Time = TransportField(..., alias="openTime")
    """
    ...
    close_time: Optional[Time] = TransportField(None, alias="closeTime")
    """
    ...
    take_profit_order_id: Optional[OrderId] = TransportField(None, alias="takeProfitOrderID")
    """
    ID of the Trade's Take Profit Order, only provided if such an Order exists.
    """

    stop_loss_order_id: Optional[OrderId] = TransportField(None, alias="stopLossOrderID")
    """
    ID of the Trade's Stop Loss Order, only provided if such an Order exists.
    """

    guaranteed_stop_loss_order_id: Optional[OrderId] = TransportField(None, alias="guaranteedStopLossOrderID ")
    """
    ...
    trailing_stop_loss_order_id: Optional[OrderId] = TransportField(None, alias="trailingStopLossOrderID")
    """
