...
class TradeSummary(BaseModel):
    ...
    take_profit_order_id: Optional[StrictStr] = Field(None, alias="takeProfitOrderID", description="ID of the Trade's Take Profit Order, only provided if such an Order exists.")
    stop_loss_order_id: Optional[StrictStr] = Field(None, alias="stopLossOrderID", description="ID of the Trade's Stop Loss Order, only provided if such an Order exists.")
    trailing_stop_loss_order_id: Optional[StrictStr] = Field(None, alias="trailingStopLossOrderID", description="ID of the Trade's Trailing Stop Loss Order, only provided if such an Order exists.")
    additional_properties: Dict[str, Any] = {}
    __properties = ["id", "instrument", "price", "openTime", "state", "initialUnits", "initialMarginRequired", "currentUnits", "realizedPL", "unrealizedPL", "marginUsed", "averageClosePrice", "closingTransactionIDs", "financing", "closeTime", "clientExtensions", "takeProfitOrderID", "stopLossOrderID", "trailingStopLossOrderID"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TradeSummary:
        """Create an instance of TradeSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TradeSummary.parse_obj(obj)

        _obj = TradeSummary.parse_obj({
            "id": obj.get("id"),
            ...
            "take_profit_order_id": obj.get("takeProfitOrderID"),
            "stop_loss_order_id": obj.get("stopLossOrderID"),
            "trailing_stop_loss_order_id": obj.get("trailingStopLossOrderID")
        })
