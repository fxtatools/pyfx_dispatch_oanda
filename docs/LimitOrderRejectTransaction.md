...
limit_order_reject_transaction_instance = LimitOrderRejectTransaction.from_json(json)
# print the JSON string representation of the object
print LimitOrderRejectTransaction.to_json()

# convert the object into a dict
limit_order_reject_transaction_dict = limit_order_reject_transaction_instance.to_dict()
# create an instance of LimitOrderRejectTransaction from a dict
limit_order_reject_transaction_form_dict = limit_order_reject_transaction.from_dict(limit_order_reject_transaction_dict)
```
