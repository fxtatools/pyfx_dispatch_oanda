...
stop_loss_order_transaction_instance = StopLossOrderTransaction.from_json(json)
# print the JSON string representation of the object
print StopLossOrderTransaction.to_json()

# convert the object into a dict
stop_loss_order_transaction_dict = stop_loss_order_transaction_instance.to_dict()
# create an instance of StopLossOrderTransaction from a dict
stop_loss_order_transaction_form_dict = stop_loss_order_transaction.from_dict(stop_loss_order_transaction_dict)
```
