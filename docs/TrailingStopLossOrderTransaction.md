...
json = "{}"
# create an instance of TrailingStopLossOrderTransaction from a JSON string
trailing_stop_loss_order_transaction_instance = TrailingStopLossOrderTransaction.from_json(json)
# print the JSON string representation of the object
print TrailingStopLossOrderTransaction.to_json()

# convert the object into a dict
trailing_stop_loss_order_transaction_dict = trailing_stop_loss_order_transaction_instance.to_dict()
# create an instance of TrailingStopLossOrderTransaction from a dict
trailing_stop_loss_order_transaction_form_dict = trailing_stop_loss_order_transaction.from_dict(trailing_stop_loss_order_transaction_dict)
```
