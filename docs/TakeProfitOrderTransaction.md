...
take_profit_order_transaction_instance = TakeProfitOrderTransaction.from_json(json)
# print the JSON string representation of the object
print TakeProfitOrderTransaction.to_json()

# convert the object into a dict
take_profit_order_transaction_dict = take_profit_order_transaction_instance.to_dict()
# create an instance of TakeProfitOrderTransaction from a dict
take_profit_order_transaction_form_dict = take_profit_order_transaction.from_dict(take_profit_order_transaction_dict)
```
