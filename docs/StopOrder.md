...
stop_order_instance = StopOrder.from_json(json)
# print the JSON string representation of the object
print StopOrder.to_json()

# convert the object into a dict
stop_order_dict = stop_order_instance.to_dict()
# create an instance of StopOrder from a dict
stop_order_form_dict = stop_order.from_dict(stop_order_dict)
```
