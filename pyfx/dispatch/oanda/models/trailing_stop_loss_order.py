...
class TrailingStopLossOrder(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The type of the Order. Always set to \"TRAILING_STOP_LOSS\" for Trailing Stop Loss Orders.")
    ...
    __properties = ["id", "createTime", "state", "clientExtensions", "type", "tradeID", "clientTradeID", "distance", "timeInForce", "gtdTime", "triggerCondition", "trailingStopValue", "fillingTransactionID", "filledTime", "tradeOpenedID", "tradeReducedID", "tradeClosedIDs", "cancellingTransactionID", "cancelledTime", "replacesOrderID", "replacedByOrderID"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingStopLossOrder:
        """Create an instance of TrailingStopLossOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrailingStopLossOrder.parse_obj(obj)

        _obj = TrailingStopLossOrder.parse_obj({
            "id": obj.get("id"),
