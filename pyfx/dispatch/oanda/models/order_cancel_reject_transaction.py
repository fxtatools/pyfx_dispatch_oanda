...
class OrderCancelRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"ORDER_CANCEL_REJECT\" for an OrderCancelRejectTransaction.")
    order_id: Optional[StrictStr] = Field(None, alias="orderID", description="The ID of the Order intended to be cancelled")
    client_order_id: Optional[StrictStr] = Field(None, alias="clientOrderID", description="The client ID of the Order intended to be cancelled (only provided if the Order has a client Order ID).")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "orderID", "clientOrderID", "rejectReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderCancelRejectTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderCancelRejectTransaction:
        """Create an instance of OrderCancelRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderCancelRejectTransaction.parse_obj(obj)

        _obj = OrderCancelRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
