...
class ReopenTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"REOPEN\" in a ReopenTransaction.")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReopenTransaction:
        """Create an instance of ReopenTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReopenTransaction.parse_obj(obj)

        _obj = ReopenTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
