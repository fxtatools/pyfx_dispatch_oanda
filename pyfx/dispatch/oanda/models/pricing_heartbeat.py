...
class PricingHeartbeat(BaseModel):
    ...
    time: Optional[StrictStr] = Field(None, description="The date/time when the Heartbeat was created.")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PricingHeartbeat:
        """Create an instance of PricingHeartbeat from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PricingHeartbeat.parse_obj(obj)

        _obj = PricingHeartbeat.parse_obj({
            "type": obj.get("type"),
            "time": obj.get("time")
        })
