...
class GetAccount200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAccount200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAccount200Response:
        """Create an instance of GetAccount200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAccount200Response.parse_obj(obj)

        _obj = GetAccount200Response.parse_obj({
