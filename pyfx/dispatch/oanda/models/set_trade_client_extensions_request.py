...
class SetTradeClientExtensionsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetTradeClientExtensionsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetTradeClientExtensionsRequest:
        """Create an instance of SetTradeClientExtensionsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetTradeClientExtensionsRequest.parse_obj(obj)

        _obj = SetTradeClientExtensionsRequest.parse_obj({
