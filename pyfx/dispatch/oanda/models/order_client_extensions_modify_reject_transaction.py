...
class OrderClientExtensionsModifyRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"ORDER_CLIENT_EXTENSIONS_MODIFY_REJECT\" for a OrderClientExtensionsModifyRejectTransaction.")
    order_id: Optional[StrictStr] = Field(None, alias="orderID", description="The ID of the Order who's client extensions are to be modified.")
    client_order_id: Optional[StrictStr] = Field(None, alias="clientOrderID", description="The original Client ID of the Order who's client extensions are to be modified.")
    client_extensions_modify: Optional[ClientExtensions] = Field(None, alias="clientExtensionsModify")
    trade_client_extensions_modify: Optional[ClientExtensions] = Field(None, alias="tradeClientExtensionsModify")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "orderID", "clientOrderID", "clientExtensionsModify", "tradeClientExtensionsModify", "rejectReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderClientExtensionsModifyRejectTransaction:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of client_extensions_modify
        if self.client_extensions_modify:
            _dict['clientExtensionsModify'] = self.client_extensions_modify.to_dict()
        # override the default output from pydantic by calling `to_dict()` of trade_client_extensions_modify
        if self.trade_client_extensions_modify:
            _dict['tradeClientExtensionsModify'] = self.trade_client_extensions_modify.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderClientExtensionsModifyRejectTransaction:
        """Create an instance of OrderClientExtensionsModifyRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderClientExtensionsModifyRejectTransaction.parse_obj(obj)

        _obj = OrderClientExtensionsModifyRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
            ...
            "client_extensions_modify": ClientExtensions.from_dict(obj.get("clientExtensionsModify")) if obj.get("clientExtensionsModify") is not None else None,
            "trade_client_extensions_modify": ClientExtensions.from_dict(obj.get("tradeClientExtensionsModify")) if obj.get("tradeClientExtensionsModify") is not None else None,
