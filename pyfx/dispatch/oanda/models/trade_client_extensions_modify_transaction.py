...
class TradeClientExtensionsModifyTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"TRADE_CLIENT_EXTENSIONS_MODIFY\" for a TradeClientExtensionsModifyTransaction.")
    trade_id: Optional[StrictStr] = Field(None, alias="tradeID", description="The ID of the Trade who's client extensions are to be modified.")
    client_trade_id: Optional[StrictStr] = Field(None, alias="clientTradeID", description="The original Client ID of the Trade who's client extensions are to be modified.")
    trade_client_extensions_modify: Optional[ClientExtensions] = Field(None, alias="tradeClientExtensionsModify")
    additional_properties: Dict[str, Any] = {}
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "tradeID", "clientTradeID", "tradeClientExtensionsModify"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TradeClientExtensionsModifyTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TradeClientExtensionsModifyTransaction:
        """Create an instance of TradeClientExtensionsModifyTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TradeClientExtensionsModifyTransaction.parse_obj(obj)

        _obj = TradeClientExtensionsModifyTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
