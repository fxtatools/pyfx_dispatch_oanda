...
class OrderClientExtensionsModifyTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"ORDER_CLIENT_EXTENSIONS_MODIFY\" for a OrderClienteExtensionsModifyTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "orderID", "clientOrderID", "clientExtensionsModify", "tradeClientExtensionsModify"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderClientExtensionsModifyTransaction:
        """Create an instance of OrderClientExtensionsModifyTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderClientExtensionsModifyTransaction.parse_obj(obj)

        _obj = OrderClientExtensionsModifyTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
