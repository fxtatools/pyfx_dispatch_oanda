...
class MarketIfTouchedOrder(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The type of the Order. Always set to \"MARKET_IF_TOUCHED\" for Market If Touched Orders.")
    ...
    initial_market_price: Optional[StrictStr] = Field(None, alias="initialMarketPrice", description="The Market price at the time when the MarketIfTouched Order was created.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MarketIfTouchedOrder:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarketIfTouchedOrder:
        """Create an instance of MarketIfTouchedOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarketIfTouchedOrder.parse_obj(obj)

        _obj = MarketIfTouchedOrder.parse_obj({
            "id": obj.get("id"),
            ...
            "initial_market_price": obj.get("initialMarketPrice"),
