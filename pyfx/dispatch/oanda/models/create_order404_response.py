...
class CreateOrder404Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrder404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrder404Response:
        """Create an instance of CreateOrder404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrder404Response.parse_obj(obj)

        _obj = CreateOrder404Response.parse_obj({
