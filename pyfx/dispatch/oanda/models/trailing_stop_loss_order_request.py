...
class TrailingStopLossOrderRequest(BaseModel):
    """
    A TrailingStopLossOrderRequest specifies the parameters that may be set when creating a Trailing Stop Loss Order.
    """
    type: Optional[StrictStr] = Field(None, description="The type of the Order to Create. Must be set to \"TRAILING_STOP_LOSS\" when creating a Trailng Stop Loss Order.")
    ...
    __properties = ["type", "tradeID", "clientTradeID", "distance", "timeInForce", "gtdTime", "triggerCondition", "clientExtensions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrailingStopLossOrderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingStopLossOrderRequest:
        """Create an instance of TrailingStopLossOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrailingStopLossOrderRequest.parse_obj(obj)

        _obj = TrailingStopLossOrderRequest.parse_obj({
            "type": obj.get("type"),
