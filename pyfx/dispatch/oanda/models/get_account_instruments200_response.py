...
class GetAccountInstruments200Response(BaseModel):
    """
    GetAccountInstruments200Response
    """
    instruments: Optional[conlist(Instrument)] = Field(None, description="The requested list of instruments.")
    ...
    __properties = ["instruments", "lastTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAccountInstruments200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAccountInstruments200Response:
        """Create an instance of GetAccountInstruments200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAccountInstruments200Response.parse_obj(obj)

        _obj = GetAccountInstruments200Response.parse_obj({
            "instruments": [Instrument.from_dict(_item) for _item in obj.get("instruments")] if obj.get("instruments") is not None else None,
