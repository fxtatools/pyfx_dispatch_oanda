...
class ClientConfigureTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"CLIENT_CONFIGURE\" in a ClientConfigureTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "alias", "marginRate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientConfigureTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientConfigureTransaction:
        """Create an instance of ClientConfigureTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientConfigureTransaction.parse_obj(obj)

        _obj = ClientConfigureTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
