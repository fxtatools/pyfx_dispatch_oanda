...
class GetInstrumentCandles400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInstrumentCandles400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInstrumentCandles400Response:
        """Create an instance of GetInstrumentCandles400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInstrumentCandles400Response.parse_obj(obj)

        _obj = GetInstrumentCandles400Response.parse_obj({
