...
class GetInstrumentPrice200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInstrumentPrice200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInstrumentPrice200Response:
        """Create an instance of GetInstrumentPrice200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInstrumentPrice200Response.parse_obj(obj)

        _obj = GetInstrumentPrice200Response.parse_obj({
