...
class TransferFundsRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"TRANSFER_FUNDS_REJECT\" in a TransferFundsRejectTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "amount", "fundingReason", "comment", "rejectReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferFundsRejectTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferFundsRejectTransaction:
        """Create an instance of TransferFundsRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferFundsRejectTransaction.parse_obj(obj)

        _obj = TransferFundsRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
