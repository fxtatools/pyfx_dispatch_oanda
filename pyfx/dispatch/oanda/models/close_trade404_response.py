...
class CloseTrade404Response(BaseModel):
    """
    CloseTrade404Response
    """
    order_reject_transaction: Optional[MarketOrderRejectTransaction] = Field(None, alias="orderRejectTransaction")
    ...
    __properties = ["orderRejectTransaction", "lastTransactionID", "relatedTransactionIDs", "errorCode", "errorMessage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloseTrade404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloseTrade404Response:
        """Create an instance of CloseTrade404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloseTrade404Response.parse_obj(obj)

        _obj = CloseTrade404Response.parse_obj({
            "order_reject_transaction": MarketOrderRejectTransaction.from_dict(obj.get("orderRejectTransaction")) if obj.get("orderRejectTransaction") is not None else None,
