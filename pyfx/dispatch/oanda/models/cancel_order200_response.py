...
class CancelOrder200Response(BaseModel):
    """
    ...
    __properties = ["orderCancelTransaction", "relatedTransactionIDs", "lastTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelOrder200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelOrder200Response:
        """Create an instance of CancelOrder200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelOrder200Response.parse_obj(obj)

        _obj = CancelOrder200Response.parse_obj({
