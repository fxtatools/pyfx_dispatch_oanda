...
class ListPendingOrders200Response(BaseModel):
    """
    ListPendingOrders200Response
    """
    orders: Optional[conlist(Order)] = Field(None, description="The list of pending Order details")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListPendingOrders200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPendingOrders200Response:
        """Create an instance of ListPendingOrders200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListPendingOrders200Response.parse_obj(obj)

        _obj = ListPendingOrders200Response.parse_obj({
