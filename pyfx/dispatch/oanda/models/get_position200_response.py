...
class GetPosition200Response(BaseModel):
    """
    ...
    __properties = ["position", "lastTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPosition200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPosition200Response:
        """Create an instance of GetPosition200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPosition200Response.parse_obj(obj)

        _obj = GetPosition200Response.parse_obj({
