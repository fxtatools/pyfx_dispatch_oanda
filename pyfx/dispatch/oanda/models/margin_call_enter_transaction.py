...
class MarginCallEnterTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"MARGIN_CALL_ENTER\" for an MarginCallEnterTransaction.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MarginCallEnterTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarginCallEnterTransaction:
        """Create an instance of MarginCallEnterTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MarginCallEnterTransaction.parse_obj(obj)

        _obj = MarginCallEnterTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
