...
class TrailingStopLossDetails(BaseModel):
    ...
    """
    distance: Optional[StrictStr] = Field(None, description="The distance (in price units) from the Trade's fill price that the Trailing Stop Loss Order will be triggered at.")
    time_in_force: Optional[StrictStr] = Field(None, alias="timeInForce", description="The time in force for the created Trailing Stop Loss Order. This may only be GTC, GTD or GFD.")
    gtd_time: Optional[StrictStr] = Field(None, alias="gtdTime", description="The date when the Trailing Stop Loss Order will be cancelled on if timeInForce is GTD.")
    client_extensions: Optional[ClientExtensions] = Field(None, alias="clientExtensions")
    additional_properties: Dict[str, Any] = {}
    __properties = ["distance", "timeInForce", "gtdTime", "clientExtensions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrailingStopLossDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingStopLossDetails:
        """Create an instance of TrailingStopLossDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrailingStopLossDetails.parse_obj(obj)

        _obj = TrailingStopLossDetails.parse_obj({
