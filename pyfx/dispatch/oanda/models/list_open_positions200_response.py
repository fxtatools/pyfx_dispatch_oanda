...
class ListOpenPositions200Response(BaseModel):
    """
    ListOpenPositions200Response
    """
    positions: Optional[conlist(Position)] = Field(None, description="The list of open Positions in the Account.")
    ...
    __properties = ["positions", "lastTransactionID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListOpenPositions200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListOpenPositions200Response:
        """Create an instance of ListOpenPositions200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListOpenPositions200Response.parse_obj(obj)

        _obj = ListOpenPositions200Response.parse_obj({
