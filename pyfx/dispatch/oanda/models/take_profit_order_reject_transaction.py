...
class TakeProfitOrderRejectTransaction(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(None, description="The Type of the Transaction. Always set to \"TAKE_PROFIT_ORDER_REJECT\" in a TakeProfitOrderRejectTransaction.")
    ...
    __properties = ["id", "time", "userID", "accountID", "batchID", "requestID", "type", "tradeID", "clientTradeID", "price", "timeInForce", "gtdTime", "triggerCondition", "reason", "clientExtensions", "orderFillTransactionID", "intendedReplacesOrderID", "rejectReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TakeProfitOrderRejectTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TakeProfitOrderRejectTransaction:
        """Create an instance of TakeProfitOrderRejectTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TakeProfitOrderRejectTransaction.parse_obj(obj)

        _obj = TakeProfitOrderRejectTransaction.parse_obj({
            "id": obj.get("id"),
            "time": obj.get("time"),
