...
class SetTradeClientExtensions404Response(BaseModel):
    """
    SetTradeClientExtensions404Response
    """
    trade_client_extensions_modify_reject_transaction: Optional[TradeClientExtensionsModifyRejectTransaction] = Field(None, alias="tradeClientExtensionsModifyRejectTransaction")
    ...
    __properties = ["tradeClientExtensionsModifyRejectTransaction", "lastTransactionID", "relatedTransactionIDs", "errorCode", "errorMessage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetTradeClientExtensions404Response:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of trade_client_extensions_modify_reject_transaction
        if self.trade_client_extensions_modify_reject_transaction:
            _dict['tradeClientExtensionsModifyRejectTransaction'] = self.trade_client_extensions_modify_reject_transaction.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetTradeClientExtensions404Response:
        """Create an instance of SetTradeClientExtensions404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetTradeClientExtensions404Response.parse_obj(obj)

        _obj = SetTradeClientExtensions404Response.parse_obj({
            "trade_client_extensions_modify_reject_transaction": TradeClientExtensionsModifyRejectTransaction.from_dict(obj.get("tradeClientExtensionsModifyRejectTransaction")) if obj.get("tradeClientExtensionsModifyRejectTransaction") is not None else None,
