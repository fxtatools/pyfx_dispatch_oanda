...
class GetTrade200Response(BaseModel):
    """
    GetTrade200Response
    """
    ...
    __properties = ["trade", "lastTransactionID"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTrade200Response:
        """Create an instance of GetTrade200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTrade200Response.parse_obj(obj)

        _obj = GetTrade200Response.parse_obj({
            "trade": Trade.from_dict(obj.get("trade")) if obj.get("trade") is not None else None,
