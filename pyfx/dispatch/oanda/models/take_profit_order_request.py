...
class TakeProfitOrderRequest(BaseModel):
    ...
    """
    type: Optional[StrictStr] = Field(None, description="The type of the Order to Create. Must be set to \"TAKE_PROFIT\" when creating a Take Profit Order.")
    ...
    __properties = ["type", "tradeID", "clientTradeID", "price", "timeInForce", "gtdTime", "triggerCondition", "clientExtensions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TakeProfitOrderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TakeProfitOrderRequest:
        """Create an instance of TakeProfitOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TakeProfitOrderRequest.parse_obj(obj)

        _obj = TakeProfitOrderRequest.parse_obj({
            "type": obj.get("type"),
