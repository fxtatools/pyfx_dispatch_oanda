...
from pyfx.dispatch.oanda.models.market_order_transaction import MarketOrderTransaction  # noqa: E501
...
class TestMarketOrderTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MarketOrderTransaction`
        """
        model = pyfx.dispatch.oanda.models.market_order_transaction.MarketOrderTransaction()  # noqa: E501
        if include_optional :
