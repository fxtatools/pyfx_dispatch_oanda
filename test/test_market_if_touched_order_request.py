...
from pyfx.dispatch.oanda.models.market_if_touched_order_request import MarketIfTouchedOrderRequest  # noqa: E501
...
class TestMarketIfTouchedOrderRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MarketIfTouchedOrderRequest`
        """
        model = pyfx.dispatch.oanda.models.market_if_touched_order_request.MarketIfTouchedOrderRequest()  # noqa: E501
        if include_optional :
