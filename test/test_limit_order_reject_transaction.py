...
from pyfx.dispatch.oanda.models.limit_order_reject_transaction import LimitOrderRejectTransaction  # noqa: E501
...
class TestLimitOrderRejectTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `LimitOrderRejectTransaction`
        """
        model = pyfx.dispatch.oanda.models.limit_order_reject_transaction.LimitOrderRejectTransaction()  # noqa: E501
        if include_optional :
