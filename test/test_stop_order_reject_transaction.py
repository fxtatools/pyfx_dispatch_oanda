...
from pyfx.dispatch.oanda.models.stop_order_reject_transaction import StopOrderRejectTransaction  # noqa: E501
...
class TestStopOrderRejectTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `StopOrderRejectTransaction`
        """
        model = pyfx.dispatch.oanda.models.stop_order_reject_transaction.StopOrderRejectTransaction()  # noqa: E501
        if include_optional :
