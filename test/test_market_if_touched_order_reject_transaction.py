...
from pyfx.dispatch.oanda.models.market_if_touched_order_reject_transaction import MarketIfTouchedOrderRejectTransaction  # noqa: E501
...
class TestMarketIfTouchedOrderRejectTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MarketIfTouchedOrderRejectTransaction`
        """
        model = pyfx.dispatch.oanda.models.market_if_touched_order_reject_transaction.MarketIfTouchedOrderRejectTransaction()  # noqa: E501
        if include_optional :
