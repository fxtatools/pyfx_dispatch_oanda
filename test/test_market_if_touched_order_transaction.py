...
from pyfx.dispatch.oanda.models.market_if_touched_order_transaction import MarketIfTouchedOrderTransaction  # noqa: E501
...
class TestMarketIfTouchedOrderTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MarketIfTouchedOrderTransaction`
        """
        model = pyfx.dispatch.oanda.models.market_if_touched_order_transaction.MarketIfTouchedOrderTransaction()  # noqa: E501
        if include_optional :
